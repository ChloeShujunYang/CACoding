...
public class SignupUseCaseFactory {
    ...
    public static SignupView create(
            ViewManagerModel viewManagerModel, LoginViewModel loginViewModel, SignupViewModel signupViewModel, SignupUserDataAccessInterface userDataAccessObject, ClearUserDataAccessInterface clearDataAccessObject) {

        try {
            SignupController signupController = createUserSignupUseCase(viewManagerModel, signupViewModel, loginViewModel, userDataAccessObject);
            ClearController clearController = createUserClearUseCase(clearDataAccessObject);
    ...
    private static ClearController createUserClearUseCase(ClearUserDataAccessInterface userDataAccessObject) throws IOException {
